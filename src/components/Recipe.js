...
function Recipe() {
  ...
  const validateImageLink = (value) => {
    if (validator.isURL(value)) {
      ...
      setErrorMessage(
        "image link must have HTTPS:// and end with png/jpeg/jpg to display image"
      );
      return false;
    }
  };
            ...
            <div class="input-group justify-content-center">
              ...
              <div class="input-group-prepend">
                ...
                <input
                  ...
                  type="url"
                  name="recipeURL"
                  placeholder="Link png/jpeg (optional)"
                  onInputCapture={(e) =>
                    validateImageLink(e.target.value) ? null : setOpen(true)
                  }
                />
                <input
                  class="form-control"
                  ...
                  onInputCapture={(e) =>
                    validate(e.target.value) ? null : setOpen(true)
                  }
                />
                <input
                  type="submit"
